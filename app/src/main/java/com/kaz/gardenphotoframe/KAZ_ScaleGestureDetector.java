...
public class KAZ_ScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
         ...
         * pointers going up.
         *
         * Once a scale has ended, {@link KAZ_ScaleGestureDetector#getFocusX()}
         * and {@link KAZ_ScaleGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(View view, KAZ_ScaleGestureDetector detector);
    }
    ...
    private KAZ_Vector2D mCurrSpanVector;
    ...
    public KAZ_ScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new KAZ_Vector2D();
    }
    ...
    public KAZ_Vector2D getCurrentSpanVector() {
